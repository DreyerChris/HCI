...
<html>
    ...
    <body class="main">
        ...
        <div class="socialnav" style="margin-top:130px;">
                <a href=""><div  class="col-xs-3 fafw" style="color:#ff4e00;">Feed</div></a>
        ...
        <div class="watched">
            ...
            <div style="padding-top: 20px;">
                    <line style="font-size: 22px;padding-left: 20px;">25 Feb at 7:22AM</line>
                    <img src="Images/Carousel/3.jpg" alt="no image" class="watchedmovie"/>
            </div>
        </div>
                <div id="lc">
