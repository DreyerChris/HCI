            ...
            echo '<div class="row"';
                echo'<div class="col-xs-12" id="movieposter">';
                    ...
                    echo'<div class="movieInfocontainer"><div class="movieInfo col-xs-8">';
                        ...
                        echo '</div>';
                        echo '<div class="row">';
                            echo'<h3 id="movieinfoheader">Running time: <span id="movieinfocontent">'.$row["runningTime"].'</span></h3>';
                        echo '</div>';
                        echo '<div class="row">';
                            echo'<h3 id="movieinfoheader">Release date: <span id="movieinfocontent">'.$row["releaseDate"].'</span></h3>';
                        echo '</div>';
                        echo '<div class="row">';
                            echo'<div id="agerestriction">'.$row["ageRestriction"].'</div>';
                        echo '</div>';
                    echo'</div>';
                    echo'<div class="movierating col-xs-4">';
                        echo'<div class="row">';
                            echo'<div class="col-xs-5 col-xs-offset-2"><a href="'.$row["IMDB"].'"><img height="70" width="120" src="Images/IMDB/IMDB_Logo.png"/></a></div>';
                            echo'<div id="movieratingtext" class="col-xs-5">'.$row["rating"].'/10</div>';
                        echo'</div>';
                        echo'<div class="row">';
